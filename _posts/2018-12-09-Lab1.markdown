...
![Blink Internal LED Code]({{ site.baseurl }}/images/L1Media/internalLED.PNG)
...
![Blink External LED Code]({{ site.baseurl }}/images/L1Media/externalLED.PNG)
...
![Potentiometer-controlled LED Code]({{ site.baseurl }}/images/L1Media/analogLED.PNG)
...
![Potentiometer-controlled LED Code]({{ site.baseurl }}/images/L1Media/ServoandPotentiometerCode.png)
